...
/bin/cp ./js/common-65.js ../WebContent/js/
#/bin/cp ./js/commonPc-03.js ../WebContent/js/
/bin/cp ./js/upload-42.js ../WebContent/js/
/bin/cp ./js/update-16.js ../WebContent/js/

CLOSURE_COMPILER_JAR="./closure-compiler-v20201006.jar"
java -jar ${CLOSURE_COMPILER_JAR} --js ./js/common-65.js --js_output_file ../WebContent/js/common-65.js
#java -jar ${CLOSURE_COMPILER_JAR} --js ./js/commonPc-03.js --js_output_file ../WebContent/js/commonPc-03.js
java -jar ${CLOSURE_COMPILER_JAR} --js ./js/upload-42.js --js_output_file ../WebContent/js/upload-42.js
java -jar ${CLOSURE_COMPILER_JAR} --js ./js/update-16.js --js_output_file ../WebContent/js/update-16.js
