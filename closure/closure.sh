...
java -jar ./closure-compiler-v20181125.jar --js ./js/upload-24.js --js_output_file ../WebContent/js/upload-24.js
java -jar ./closure-compiler-v20181125.jar --js ./js/update-04.js --js_output_file ../WebContent/js/update-04.js
