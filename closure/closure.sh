java -jar ./closure-compiler-v20181125.jar --js ./js/common-25.js --js_output_file ../WebContent/js/common-25.js
#java -jar ./closure-compiler-v20181125.jar --js ./js/commonPc-03.js --js_output_file ../WebContent/js/commonPc-03.js
#java -jar ./closure-compiler-v20181125.jar --js ./js/upload-15.js --js_output_file ../WebContent/js/upload-15.js
