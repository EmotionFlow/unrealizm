...
<html>
	<head>
		...
		<meta name="twitter:image" content="https:<%=Common.GetPoipikuUrl(strFileUrl)%>_360.jpg" />
		...
		<script type="application/ld+json">
		{
			...
			"@type":"ItemList",
			"itemListElement":[
				{"@type":"ListItem", "position":1, "url":"<%=strUrl%>", "name": "<%=Util.toDescString(strTitle)%>", "image": "https:<%=Common.GetPoipikuUrl(strFileUrl)%>_360.jpg"}
			]
		}
		</script>
