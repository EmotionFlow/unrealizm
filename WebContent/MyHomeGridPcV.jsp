...
<html lang="<%=_TEX.getLangStr()%>">
	...
	<body>
		...
		<div class="SystemInfo" id="SystemInfo_<%=cResults.m_cSystemInfo.m_nContentId%>">
			...
			<a class="SystemInfoClose" href="javascript:void(0)" onclick="$('#SystemInfo_<%=cResults.m_cSystemInfo.m_nContentId%>').hide();setCookie('<%=Common.AI_POIPIKU_INFO%>', '<%=cResults.m_cSystemInfo.m_nContentId%>')"><i class="fas fa-times"></i></a>
		</div>
		<%}%>
			...
			<aside class="PcSideBar" style="margin-top: 30px;">
				...
				<div class="PcSideBarItem">
					...
					String strTwitterUrl=String.format("https://twitter.com/intent/tweet?text=%s&url=%s",
							...
							URLEncoder.encode("https://ai.poipiku.com/"+checkLogin.m_nUserId+"/", "UTF-8"));
					%>
					<div style="text-align: center;">
						<input id="MyUrl" class="MyUrl" type="text" value="https://ai.poipiku.com/<%=checkLogin.m_nUserId%>/" onclick="this.select(); document.execCommand('copy');" style="box-sizing: border-box; width: 100%; padding: 5px; margin: 0 0 10px 0;" />
