...
function CreateIllustItemBase(cItem, nUserId, nMode) {
	...
	var $objItemThumb = $("<span/>").addClass("IllustItemThumb");
	var $objItemThumbImg = $("<img/>").addClass("IllustItemThumbImg").attr("src", cItem.file_name);
	...
	if(cItem.description.length>0){
		var $objItemCommentItem = CreateCommentItemBase(cItem.content_id, cItem.user_id, cItem.nickname, 0, '', cItem.description, nMode);
