...
class IllustViewC {
	...
	public boolean GetResults(IllustViewCParam cParam) {
		...
		try {
			...
			// content main
			strSql = "SELECT contents_0000.*, nickname, users_0000.file_name as user_file_name FROM contents_0000 INNER JOIN users_0000 ON contents_0000.user_id=users_0000.user_id WHERE contents_0000.user_id=? AND contents_0000.content_id=?";
			cState = cConn.prepareStatement(strSql);
