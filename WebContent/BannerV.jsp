...
<html style="height: 100%;">
	<head>
		...
		<style>
		body {padding: 0;}
		.Wrapper {width: 300px; height: 250px; color: #000; background: #3498db; margin: 0; padding: 14px 0;}
		.AnalogicoDesc {width: 100%; padding: 0 0 0 0; box-sizing: border-box; text-align: center; font-size: 14px; line-height: 25px; color: #000; font-weight: normal;}
