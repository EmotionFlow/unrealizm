...
String strUrl = "https://unrealizm.com/SearchIllustByGenrePcV.jsp?GD="+results.genreId;
		...
		<header class="SearchGenreFrame">
			<div class="SearchGenre">
				...
				<div class="SearchGenreCmd">
					...
					<%} else {%>
					<a class="CmdBtn BtnBase TitleCmdFollow Selected" href="javascript:void(0)" onclick="UpdateFollowGenre(<%=checkLogin.m_nUserId%>, <%=results.genreId%>)"><i class="fa fa-star"></i> <%=_TEX.T("IllustV.Favo")%></a>
					<%}%>
				</div>
			</div>
