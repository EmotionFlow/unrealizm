			...
			<div class="SettingList">
				...
				<div class="SettingListItem" style="margin-bottom: 15px; border-bottom: none;">
					...
					<div class="SettingBody" style="text-align: center;">
						<p><a href="/RuleS.jsp" style="font-size: 14px; text-decoration: underline;">利用規約</a></p>
						<p><a href="/PrivacyPolicyS.jsp" style="font-size: 14px; text-decoration: underline;">プライバシーポリシー</a></p>
					</div>
				</div>
			</div>
		</div><!--Wrapper-->
