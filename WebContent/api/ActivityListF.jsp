...
long m_lDatetime = Common.ToLong(request.getParameter("DT"));
...
try {
	...
	if (nResult == 0) {
		...
		for(CComment cComment : m_vComment) {
			...
			reaction.put("link_url", Common.GetPoipikuUrl(String.format("/%d/%d.html", m_nUserId, cComment.m_nContentId)));
