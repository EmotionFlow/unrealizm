...
<link href="/css/TMaking-193.css" type="text/css" rel="stylesheet" />
...
<script type="text/javascript" src="/js/common-106.js"></script>
...
<%} else {%>
<link href="/css/TPcAppend-83.css" type="text/css" rel="stylesheet" />
<%}%>
