...
-->
	...
	<li class="EventItem" style="background: #fff;">
		<a class="EventBanner" href="https://galleria.emotionflow.com/" target="_blank" style="background: #fff; box-sizing: border-box; padding: 10px 10px;">
	...
	<li class="EventItem">
		<a class="EventBanner" href="https://tegaki.pipa.jp/" target="_blank" style="background: #fff url('https://tegaki.pipa.jp/img10/Title_756x228.png') no-repeat center center; background-size: contain; box-sizing: border-box; border: solid 5px;">
		</a>
	</li>
