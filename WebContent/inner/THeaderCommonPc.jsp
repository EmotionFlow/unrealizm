...
<link href="/css/TMaking-117.css" type="text/css" rel="stylesheet" />
...
<script type="text/javascript" src="/js/common-44.js"></script>
...
<%} else {%>
<link href="/css/TPcAppend-65.css" type="text/css" rel="stylesheet" />
<%}%>
