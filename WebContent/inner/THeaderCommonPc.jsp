...
<link href="/css/TMaking-209.css" type="text/css" rel="stylesheet" />
<link href="/css/TBasePc-76.css" type="text/css" rel="stylesheet" />
...
<script type="text/javascript" src="/js/common-111.js"></script>
...
<%} else {%>
<link href="/css/TPcAppend-85.css" type="text/css" rel="stylesheet" />
<%}%>
<%if(checkLogin.m_nPassportId==Common.PASSPORT_OFF && g_bShowAd) {%>
