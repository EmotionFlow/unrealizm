...
<link href="/css/TMaking-188.css" type="text/css" rel="stylesheet" />
...
<script type="text/javascript" src="/js/common-103.js"></script>
...
<%} else {%>
<link href="/css/TPcAppend-80.css" type="text/css" rel="stylesheet" />
<%}%>
<%if(checkLogin.m_nPassportId==Common.PASSPORT_OFF && g_bShowAd) {%>
