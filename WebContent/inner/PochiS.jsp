...
還元率は直近の投稿枚数、絵文字送信数、Twitterからの閲覧数等に基づいて計算し、概ね70%〜80%です。<br />
溜まったポイントは1ポイント=1円で交換できます。<br />
<br />
ポチ袋を付けて送っても相手には自分の名前は伝わりません。また送れる絵文字は毎日変わるので、ポチ袋を受け取っていることもわかりにくいようになっていいます・<br />
			</div>
...
振込申請を行わない場合、最大6ヶ月分繰り越すことができます。<br />
振込申請に必要な手数料300円はポイントから差し引かれます。<br />
取得から6ヶ月過ぎたポチ袋ポイントは失効します。<br />
