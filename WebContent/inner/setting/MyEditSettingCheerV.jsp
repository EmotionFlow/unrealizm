...
<p>`+ '<%=strCheerPointTotal%>' + 'ポイントから振り込み手数料300ポイントを除いた' + '<%=strPaymentYenTotal%>' + '円を指定口座に振り込むことができます。'
						+`なお、指定できるのは日本国内の銀行口座のみです。銀行口座情報が間違っていた場合、手数料＋銀行から請求される組戻手数料の実費(銀行により異なりますが700円〜1000円程度)をご負担頂くことになりますので十分ご確認の上、申請をお願いします。</p>
</div>
