...
if (cResults.m_strKeyword.indexOf("@") == 0) {
	response.sendRedirect("https://poipiku.com/SearchUserByKeyword" + (isApp?"App":"Pc") + "V.jsp?KWD=" + URLEncoder.encode(cResults.m_strKeyword.replaceFirst("@", ""), StandardCharsets.UTF_8));
	return;
}
