		...
		<article class="Wrapper">
			<div class="SettingList">
				...
				<div class="SettingListItem">
					...
					<div class="SettingBody">
						EmotionFlowは、「unrealizm」(以下、本サービスという)において利用規約(以下、本規約)を定め、これにより本サービスを提供します。<br/>
						2.本規約は、EmotionFlowと利用者との間の一切の関係に適用します。<br/>
				...
				<div class="SettingListItem">
					...
					<div class="SettingBody">
						EmotionFlowは、本規約を利用者の承諾を得ることなく変更することがあります。この場合には、本サービスの提供条件は変更後の利用規約によります。<br/>
				...
				<div class="SettingListItem">
					...
					<div class="SettingBody">
						EmotionFlowは、本サービスに係る基本機能を次の通り提供します。<br/>
						(1)画像等データをアップロードする機能<br/>
						(2)画像等データを表示する機能<br/>
						(3)上記に付帯する機能<br/>
						2.EmotionFlowは、未登録ユーザに対して本サービスに係る基本機能の一部を提供し、登録ユーザに対して全ての基本機能を提供します。<br/>
						3.EmotionFlowが提供する基本機能は、利用者毎に異なることがあり、利用者は予めこれを異議なく承諾するものとします。<br/>
					</div>
				</div>
				...
				<div class="SettingListItem">
					...
					<div class="SettingBody">
						EmotionFlowは、本サービスの提供内容に対して利用者の承諾なしに変更できるものとします。<br/>
					</div>
				</div>
				...
				<div class="SettingListItem">
					...
					<div class="SettingBody">
						以下の場合には、EmotionFlowは予告なく本サービスの一部または全部の提供を中断もしくは中止することがあります。<br/>
				...
				<div class="SettingListItem">
					...
					<div class="SettingBody">
						EmotionFlowは、登録の申込に対して受け付けた順序に承諾します。ただし、承諾後に審査を行い、以下に該当する場合は遡って承諾を取り消すことがあります。<br/>
						(1)EmotionFlowが、本サービスを提供することが困難と判断した場合<br/>
						(2)申し込みをした者が、本サービスならびにEmotionFlowが提供する他のサービスにおいて利用を停止されている、または利用の解除を受けたことがある場合<br/>
						(3)申込み内容に虚偽がある場合<br/>
						(4)申し込みをした者が、第17条(遵守事項)、第18条(禁止事項)に違反して本サービスを利用する恐れがあるとEmotionFlowが判断した場合<br/>
						...
						(6)その他、EmotionFlowが運営上不適当であると判断した場合<br/>
					</div>
				</div>
				...
				<div class="SettingListItem">
					...
					<div class="SettingBody">
						EmotionFlowは登録申し込みの承諾を取り消した利用者に対し、一切の通知や予告なく登録を削除します。その際理由の一切について説明しません。<br/>
					</div>
				</div>
				...
				<div class="SettingListItem">
					...
					<div class="SettingBody">
						登録ユーザの登録期間は無期限とします。ただし、第6条(本サービスの提供の中断と中止)、第13条(登録解除)、第21条(EmotionFlowによる利用の停止と登録の解除)の場合はこの限りではありません。<br/>
					</div>
				</div>
				...
				<div class="SettingListItem">
					...
					<div class="SettingBody">
						...
						2.登録解除後、EmotionFlowは予告なく直ちにサーバから当該利用者の一切のデータ等を削除します。<br/>
					</div>
				</div>
				...
				<div class="SettingListItem">
					...
					<div class="SettingBody">
						利用者が本サービスを利用して投稿した画像等データ及びそれに付随する情報の著作権(著作権法第27条及び第28条の権利を含む全ての著作権者の権利をいう)及びその他一切の権利は利用者に帰属し、利用者はEmotionFlowに対しサムネイルの表示等、本サービスを運営するに当たり必要となる最小限の改変と使用を承諾するものとします。<br/>
						2.登録申し込みの承諾はEmotionFlowが利用者へ本サービスの基本機能の使用を承諾するものであり、利用者に本サービスそのものもしくはその一部、及び著作権等の一切の権利を譲渡するものではありません。<br/>
					</div>
				</div>
				...
				<div class="SettingListItem">
					...
					<div class="SettingBody">
						...
						(8)利用者およびEmotionFlowによって規定された<a href="/GuideLinePcV.jsp">ガイドラン</a>に従うこと<br/>
						(9)その他、EmotionFlowが必要と判断し、行った要請に無条件で従うこと<br/>
					</div>
				</div>
				...
				<div class="SettingListItem">
					...
					<div class="SettingBody">
						...
						(24)その他、EmotionFlowが不適切であると判断した行為<br/>
					</div>
				</div>
				...
				<div class="SettingListItem">
					...
					<div class="SettingBody">
						EmotionFlowは、EmotionFlowが定める「プライバシーポリシー」に従い、本サービスのために利用者の個人情報を適切に収集・利用・管理します。<br/>
					</div>
				</div>
				...
				<div class="SettingListItem">
					...
					<div class="SettingBody">
						EmotionFlowは、本サービスで知り得た通信内容に関して守秘の義務を負い、利用者の保護を最優先するものとします。<br/>
						2.以下の各号に定める場合に､EmotionFlowは利用者の同意なく通信内容を第三者に開示することができるものとします｡なお､EmotionFlowは､この開示により利用者に生じたいかなる損害についても､一切責任を負わないものとします｡<br/>
						(1)刑事訴訟法第218条(令状による差押え･捜索･検証)及び、その他法令の定めに基づく強制の処分が行なわれた場合<br/>
						(2)特定電気通信役務提供者の損害賠償責任の制限及び発信者情報の開示に関する法律第4条(発信者情報の開示請求等)に基づく開示請求の要件が社会通念上十分に満たされているとEmotionFlowが判断した場合<br/>
						(3)裁判所や警察等の公的機関から､法令に基づく命令を受けた場合<br/>
						(4)心身または財産を保護するために必要があるとEmotionFlowが判断した場合<br/>
				...
				<div class="SettingListItem">
					<div class="SettingListTitle">第21条(EmotionFlowによる利用の停止と登録の解除)</div>
					<div class="SettingBody">
						EmotionFlowは、利用者が以下のいずれかに該当する場合は、何らの催促及び自己の債務の履行の提供をしないで、画像等データの一部または全部の変更及び削除、あるいは本サービスの利用停止、もしくは登録の解除を行うことができます。<br/>
						...
						(7)画像等データが公序良俗に反するとEmotionFlowが判断した場合<br/>
						(8)その他、EmotionFlowの業務上不適当であるとEmotionFlowが判断した場合<br/>
						2.EmotionFlowは、利用者から前項各号に該当する可能性のある利用者もしくは画像等データに関する報告があった場合、24時間以内を基準としてその判断および対応を行います。その際の判断過程、判断結果および対処内容の一切について説明しません。<br/>
						3.前項及び前々項において、判断及び対処までに要する間、当該利用者もしくは画像等データが表示されることがあります。ただし、表示を以って許容を示すものではありません。<br/>
						4.登録解除後、EmotionFlowは予告なく直ちにサーバから当該利用者の一切のデータ等を削除します。<br/>
					</div>
				</div>
				...
				<div class="SettingListItem">
					...
					<div class="SettingBody">
						EmotionFlowは、本サービスの利用および本規約に起因する損害について、その予測可能性に関わらず一切の責を負わないものとします。<br/>
						2.EmotionFlowは、データの一部または全部が消失した場合について、その責を負わないものとします。<br/>
						3.EmotionFlowは、本サービスが提供する情報の品質、正確性、完全性、適合性、有効性、利用可能性、時刻一致性、安全性、取得方法、知的財産権等の非侵害性及び法令による責任を何ら保証しないものとします。<br/>
						4.利用者、ならびに利用者の関係者が本サービスを通じて第三者に損害を与えた場合についてその責を負わないものとし、当該利用者は、自らの責任において問題を解決するものとします。<br/>
						5.EmotionFlowは、利用者の利用環境について一切関与せず、また一切の責任を負いません。<br/>
						6.EmotionFlowが何かしらの対処を行わないことを以って本規約に抵触していないことを保証するものではありません。<br/>
					</div>
				</div>
				...
				<div class="SettingListItem">
					...
					<div class="SettingBody">
						利用者が本規約に反した行為、または不正もしくは違法な行為によってEmotionFlowに損害を与えた場合、EmotionFlowは利用者に対してこの損害及び弁護士費用を含む一切の費用の賠償を請求することができ、利用者は、当該請求に直ちに応じなければならないものとします。<br/>
					</div>
				</div>
				...
				<div class="SettingListItem">
					...
					<div class="SettingBody">
						本サービスの利用について利用者とEmotionFlowの間で問題が生じたときは、利用者とEmotionFlowで誠意を持って協議し解決するものとします。<br/>
